 ...
 * Description: 使用JedisPool来管理redis的工具类
 */
...
public class JedisPoolUtil {
     ...
     * @return 成功返回1 如果存在 和 发生异常 返回 0
     */
    public Long expire(byte[] key, int value, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
   ...
   /**
     * 返还到连接池，该方法在maven依赖的jedis3.0以下还能用，3.0以上只能使用以下的关闭连接方法了。
     *
     * @param jedisPool
     * @param jedis
     */
   ...
   /* *//**
     * 关闭连接，该方法在maven依赖的jedis3.0以上使用，不能使用以上的返还到连接池方法了
     *
     * @param jedis
     *//*
